...
describe("EventValidator", () => {
    describe("validateEvent", () => {
        test("should validate a proper event", () => {
            ...
            const result = EventValidator_1.EventValidator.validateEvent(event);
    ...
    describe("validateEvents", () => {
        test("should validate multiple events", () => {
            ...
            const result = EventValidator_1.EventValidator.validateEvents(events);
...
//# sourceMappingURL=EventValidator.test.js.map