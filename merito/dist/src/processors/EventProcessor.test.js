...
describe("EventProcessor", () => {
    describe("processEvents", () => {
        test("should group and sort events by service", () => {
            ...
            const result = EventProcessor_1.EventProcessor.processEvents(rawEvents);
    ...
    describe("getServiceNames", () => {
        test("should return all service names", () => {
            ...
            const result = EventProcessor_1.EventProcessor.getServiceNames(serviceEvents);
    ...
    describe("getEventsForService", () => {
        test("should return events for specified service", () => {
            ...
            const result = EventProcessor_1.EventProcessor.getEventsForService(serviceEvents, "email");
        ...
        test("should return empty array for non-existent service", () => {
            ...
            const result = EventProcessor_1.EventProcessor.getEventsForService(serviceEvents, "nonexistent");
